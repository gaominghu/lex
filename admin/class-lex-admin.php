 ...
 * functionality, then refer to `class-lex.php`
 *
 * @package Lex_Admin
 * @author  gabrielstuff contact@soixantecircuits.fr
 */
class Lex_Admin {
	...
	public function enqueue_admin_styles() {
		...
		if ( $this->plugin_screen_hook_suffix == $screen->id ) {
			wp_enqueue_style( $this->plugin_slug .'-admin-styles', plugins_url( 'assets/css/admin.css', __FILE__ ), array(), Lex::VERSION );
		}
	...
	public function enqueue_admin_scripts() {
		...
		$screen = get_current_screen();
		if ( $this->plugin_screen_hook_suffix == $screen->id ) {
			wp_enqueue_script( $this->plugin_slug . '-admin-script', plugins_url( 'assets/js/admin.js', __FILE__ ), array( 'jquery' ), Lex::VERSION );
		}
	...
	public function add_plugin_admin_menu() {
		...
		$this->plugin_screen_hook_suffix = add_options_page(
			__( 'Lexicon options', $this->plugin_slug ),
			__( 'Lexicon', $this->plugin_slug ),
			'manage_options',
			$this->plugin_slug,
